...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="{{ url('public/dist/css/bootstrap-material-design.css') }}">
        <link rel="stylesheet" type="text/css" href="{{ url('public/dist/css/ripples.min.css') }}">
                ...
                <div class="collapse navbar-collapse" id="app-navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/employee') }}"></i>Employee</a></li>
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="{{ url('/job_type') }}">Job Type</a></li>
